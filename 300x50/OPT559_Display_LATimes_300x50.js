...
lib.ssMetadata = [
		{name:"OPT559_Display_LATimes_300x50_atlas_1", frames: [[246,502,338,33],[0,502,244,74],[0,0,600,500]]}
];
...
(lib.CachedBmp_9 = function() {
	this.initialize(ss["OPT559_Display_LATimes_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.OPT559_Display_LATimes_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-64,-11.2,598,140.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT559_Display_LATimes_300x50_atlas_1.png", id:"OPT559_Display_LATimes_300x50_atlas_1"}
	],
	preloads: []
};
