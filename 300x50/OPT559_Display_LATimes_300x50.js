...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(42).to({regY:0.1,scaleX:0.6,scaleY:0.6,y:25.3},10,cjs.Ease.quadIn).wait(11));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT559_Display_LATimes_300x50_atlas_1.png?1670543637996", id:"OPT559_Display_LATimes_300x50_atlas_1"}
	],
	preloads: []
};
